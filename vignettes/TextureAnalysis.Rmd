...
##Gray Level Size Zone Matrix (GLSZM) and Multiple-GLSZM
...
For the GLSZM let's look at a more complicated image, that of a tumor, but discretized into only 16 grey levels (using the `discretizeImage` function incldued in the package)
